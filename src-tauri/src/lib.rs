...
mod git;
use git::{git_branch_create, git_branch_delete, git_branch_rename, git_branches, git_checkout, git_clean, git_commit, git_diff, git_diff_stat, git_discard, git_fetch, git_log, git_merge_abort, git_merge_continue, git_publish, git_pull, git_push, git_rebase_abort, git_rebase_continue, git_rebase_skip, git_remotes, git_reset, git_resolve, git_root, git_stage, git_stash_apply, git_stash_clear, git_stash_drop, git_stash_list, git_stash_pop, git_stash_push, git_status, git_sync, git_unstage, git_watch};

...
const en: Dict = {
  ...
  "sidebar.collapsed.expand": "Show session history",
  ...
  "git.gen.all": "Generate message ({model}){body} — for All",
  ...
  "git.commit.hint.all": "Commit all changes (incl. untracked)",
  "git.commit.hint.stagedPush": "Commit staged and push",
  "git.commit.hint.allPush": "Commit all changes and push",
  "git.commit.hint.stagedSync": "Commit staged and sync (pull then push)",
  "git.commit.hint.allSync": "Commit all changes and sync",
  ...
  "git.hint.noStagedButAll": "No staged changes. Commit All will commit all changes (incl. untracked).",
  ...
  "question.fromSubagent": "Subagent · {title}",
  "question.viewTranscript": "View subagent transcript",
...
const fr: Dict = {
  ...
  "sidebar.collapsed.expand": "Afficher l'historique",
  "titlebar.agents": "Agents",
  "titlebar.agentsTip": "Agents ({hotkey})",
  ...
  "git.gen.all": "Générer message ({model}){body} — pour All",
  ...
  "git.commit.hint.all": "Commiter tous les changements (incl. non-suivis)",
  "git.commit.hint.stagedPush": "Commiter le staged et pousser",
  "git.commit.hint.allPush": "Commiter tous les changements et pousser",
  "git.commit.hint.stagedSync": "Commiter le staged et synchroniser (pull puis push)",
  "git.commit.hint.allSync": "Commiter tous les changements et synchroniser",
  ...
  "git.hint.noStagedButAll": "Pas de staged. Commit All commisera tous les changements (incl. non-suivis).",
  ...
  "question.fromSubagent": "Sous-agent · {title}",
  "question.viewTranscript": "Voir la transcription du sous-agent",
...
const es: Dict = {
  ...
  "sidebar.collapsed.expand": "Mostrar historial",
  ...
  "git.gen.all": "Generar mensaje ({model}){body} — para All",
  ...
  "git.commit.hint.all": "Hacer commit de todos los cambios (incl. no seguidos)",
  ...
  "git.hint.noStagedButAll": "Sin staged. Commit All hará commit de todos (incl. no seguidos).",
  ...
  "question.fromSubagent": "Subagente · {title}",
  "question.viewTranscript": "Ver la transcripción del subagente",
  "question.other": "Otro…",
